...
public class UpdatedPersonalInformationSteps {
	...
	public void I_Enter_Updated_LastName_On_MyPersonalInformation_Page(String lastName) throws PendingException, InterruptedException {
		user.enterLastNameInPersonalInfoPage(lastName);
	}
	...
	@Then("I Verify Updated (.*) Users Last Name")
	public void I_Verify_Updated_LastName_On_HomePage(String expectedLastName) throws PendingException, InterruptedException {
		user.verifyUpdatedLastNameOnHomePage(expectedLastName);
	}
...
//
//		user.addNewUserInformation(userName, password, repeatPassword);
//	}
//
...
//
//		user.addAccountInformation(firstName, lastName, emailId, phoneNumber, addr1, addr2, city, state, zipCode,
//				country);
//	}
//
...
//
//		user.addProfileInformation("english", "DOGS", true, true);
//	}
//
//	@Given("^I save my information$")
//	public void i_save_my_information() {
//
//		user.clickSaveAccountInformation();
//	}
//
...
//
//		String result = user.getGreetingMessage();
//
...
//		
//		user.searchForProduct(petType);
//		user.selectProductFromSearchTable(petType);
//	}
//
...
//		
//		user.addToCartSpecificProduct(pet);
//	}
//
//	@When("^I proceed to checkout$")
//	public void i_proceed_to_checkout() {
//		
//		user.clickOnProceedToCheckout();
//	}
//
//	@When("^I click on Continue$")
//	public void i_click_on_Continue() {
//		
//		user.clickOnContinueBtn();
//	}
//
...
//		
//		user.clickOnConfirmBtn();
//		user.verifyIfOrderSubmitted();
//	}
//
//	
...
//			throws Throwable {
//		
//		user.enterPaymentAndBillingDetails(cardType, cardNumber, expiryDate, firstname,
...
//			user.navigateToProductCategory(PetCategories.valueOf(s));
//		}
//	}
//
}
